...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eslam Selmi" },
      { name: "description", content: "Portfolio Connect transforms your static portfolio into a dynamic, modern website showcasing your work and photos." },
      { name: "author", content: "Eslam Selmi" },
      { property: "og:title", content: "Eslam Selmi" },
      { property: "og:description", content: "Portfolio Connect transforms your static portfolio into a dynamic, modern website showcasing your work and photos." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Eslam Selmi" },
      { name: "twitter:description", content: "Portfolio Connect transforms your static portfolio into a dynamic, modern website showcasing your work and photos." },

      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/070f6022-5897-439b-a8da-f3ac368b4dcf/id-preview-ac58503f--89f245e8-fae7-43be-a7fc-c95e6e265858.lovable.app-1779900015919.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/070f6022-5897-439b-a8da-f3ac368b4dcf/id-preview-ac58503f--89f245e8-fae7-43be-a7fc-c95e6e265858.lovable.app-1779900015919.png" },
    ],
    links: [
