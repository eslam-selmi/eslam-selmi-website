...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eslam Selmi — Head of L&D" },
      { name: "description", content: "Eslam Selmi — Head of L&D, Talent & Performance leader with 8+ years across 12 countries. Book a free 1:1 session." },
      { name: "author", content: "Eslam Selmi" },
      { property: "og:title", content: "Eslam Selmi — Head of L&D, Talent & Performance" },
